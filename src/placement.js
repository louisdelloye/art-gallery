...
module.exports = (regl, {placements, getAreaIndex}) => {
    ...
    const loadPainting = (p) => {
        ...
        //Offset depending on batch size and change wall consequently
        // const N = 6; // 3 on one wall, 3 on the other
        // const side = (Math.floor(batch.length / N) % 2 === 0) ? 1 : -1;
        // pos[0] -= dir[0] * d1 + norm[0] * d2 * side;
        // pos[2] -= dir[1] * d1 + norm[1] * d2 * side;
